...
class DataBaseHelper {
  String serverUrl = "http://202.43.47.251/apicloud/public/api/";
  String serverUrlproducts =
      "http://202.43.47.251/apicloud/public/api/products";
...
//function for register products
  void addDataProducto(String _nameController, String _priceController,
    ...
    String myUrl = "http://202.43.47.251/apicloud/public/api/products";
  ...
  void editarData(String id, String name, String price, String stock) async {
    ...
    String myUrl = "http://202.43.47.251/apicloud/public/api/products/$id";
